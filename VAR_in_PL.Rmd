...
aux <- c(aux,length(details_data_19_20))

for(t in 1:(length(aux)-1)){
  cont <- 0
  for(u in seq(aux[t],aux[t+1])){
...
for(r in 1:length(details_data_19_20)){
  if(details_data_19_20[r] == "Game:"){
    game_detail <- c(game_detail,details_data_19_20[r+1])
  }
  if(details_data_19_20[r] == "Incident:"){
    incident_detail <- c(incident_detail,details_data_19_20[r+1])
  }
}
```
